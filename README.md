# Go Stripe [![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/splice/stripe-go) [![Build Status](https://travis-ci.org/stripe/stripe-go.svg?branch=master)](https://travis-ci.org/stripe/stripe-go)
...
```sh
git clone https://github.com/splice/stripe-go.git
cd stripe-go
...
```sh
go get github.com/splice/stripe-go
```
...
import (
	...
	"github.com/splice/stripe-go/client"
)
...
import (
	"github.com/splice/stripe-go"
	"github.com/splice/stripe-go/$resource$"
)
...
[godoc]: http://godoc.org/github.com/splice/stripe-go
[issues]: https://github.com/splice/stripe-go/issues/new
[package-management]: https://code.google.com/p/go-wiki/wiki/PackageManagementTools
[pulls]: https://github.com/splice/stripe-go/pulls
